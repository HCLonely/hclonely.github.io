    ...
    return function(e) {
        ...
        function(e, t, n) {
            ...
            r = function(e, t) {
                        ...
                        return function(e) {
                            ...
                            function n() {
                                if (0 !== e.scrollHeight) {
                                    ...
                                    e.style.height = "", e.style.height = e.scrollHeight + a + "px", s = e.clientWidth, t.forEach(function(e) {
                            ...
                            function r() {
                                ...
                                var r = Math.round(parseFloat(e.style.height)),
                                    ...
                                    a = "content-box" === i.boxSizing ? Math.round(parseFloat(i.height)) : e.offsetHeight;
                                if (a < r ? "hidden" === i.overflowY && (t("scroll"), n(), a = "content-box" === i.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight) : "hidden" !== i.overflowY && (t("hidden"), n(), a = "content-box" === i.boxSizing ? Math.round(parseFloat(window.getComputedStyle(e, null).height)) : e.offsetHeight), l !== a) {
                                    l = a;
                            ...
                            if (e && e.nodeName && "TEXTAREA" === e.nodeName && !i.has(e)) {
                                ...
                                e.addEventListener("autosize:destroy", d, !1), "onpropertychange" in e && "oninput" in e && e.addEventListener("keyup", r, !1), window.addEventListener("resize", c, !1), e.addEventListener("input", r, !1), e.addEventListener("autosize:update", r, !1), e.style.overflowX = "hidden", e.style.wordWrap = "break-word", i.set(e, {
                                    destroy: d,
                                    update: r
                                }),
                                function() {
                                    var t = window.getComputedStyle(e, null);
                                    "vertical" === t.resize ? e.style.resize = "none" : "both" === t.resize && (e.style.resize = "horizontal"), a = "content-box" === t.boxSizing ? -(parseFloat(t.paddingTop) + parseFloat(t.paddingBottom)) : parseFloat(t.borderTopWidth) + parseFloat(t.borderBottomWidth), isNaN(a) && (a = 0), r()
                                }()
                            }
                        }(e)
                    }), e
                ...
                default
            }, void 0 !== (i = r.apply(t, [e, t])) && (e.exports = i)
        },
        function(e, t, n) {
            "use strict";
            ...
            r.prototype.init = function(e) {
                var t = this;
                if (t.config = e, "undefined" != typeof document) return "undefined" == typeof AV ? u.dynamicLoadSource("script", {
                ...
                try {
                    ...
                    z = e.config.serverURLs || q + "avoscloud.com", M !== AV._config.applicationId && C !== AV._config.applicationKey && AV.init({
                        appId: M,
                        appKey: C,
                        serverURLs: z
                    });
                    ...
                    var j = e.config.el || null,
                        R = u.findAll(document, j);
                    if (!(j = j instanceof HTMLElement ? j : R[R.length - 1] || null)) return;
                    ...
                    e.placeholder = e.config.placeholder || "Just Go Go", e.el.innerHTML = '<div class="vwrap"><div class="vheader item' + B.length + '">' + B.join("") + '</div><div class="vedit"><textarea id="veditor" class="veditor vinput" placeholder="' + e.placeholder + '"></textarea><div class="vctrl"><span class="vemoji-btn">' + e.locale.ctrl.emoji + '</span> | <span class="vpreview-btn">' + e.locale.ctrl.preview + '</span></div><div class="vemojis" style="display:none;"></div><div class="vinput vpreview" style="display:none;"></div></div><div class="vcontrol"><div class="col col-20" title="Markdown is supported"><a href="https://segmentfault.com/markdown" target="_blank"><svg class="markdown" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z"></path></svg></a></div><div class="col col-80 text-right"><button type="button" title="Cmd|Ctrl+Enter" class="vsubmit vbtn">' + e.locale.ctrl.reply + '</button></div></div><div style="display:none;" class="vmark"></div></div><div class="vinfo" style="display:none;"><div class="vcount col"></div></div><div class="vlist"></div><div class="vempty" style="display:none;"></div><div class="vpage txt-center"></div><div class="info"><div class="power txt-right">Powered By <a href="https://valine.js.org" target="_blank">Valine</a><br>' + o + "</div></div>";
                    var P = u.find(e.el, ".vempty");
                    e.nodata = {
                        show: function(t) {
                            return P.innerHTML = t || e.locale.tips.sofa, u.attr(P, "style", "display:block;"), e
                        },
                        hide: function() {
                            return u.attr(P, "style", "display:none;"), e
                        }
                    };
                    var U = u.create("div", "class", "vloading"),
                        I = u.find(e.el, ".vlist");
                    e.loading = {
                        show: function(t) {
                            var n = u.findAll(I, ".vcard");
                            return t ? I.insertBefore(U, n[0]) : I.appendChild(U), e.nodata.hide(), e
                        },
                        hide: function() {
                            var t = u.find(I, ".vloading");
                            return t && u.remove(t), 0 === u.findAll(I, ".vcard").length && e.nodata.show(), e
                        }
                    };
                    ...
                    e.alert = {
                        show: function(t) {
                            ...
                            if (n.innerHTML = "" + r + (t && t.type && i), u.on("click", u.find(N, ".vcancel"), function(t) {
                                e.alert.hide()
            ...
            r.prototype.Q = function(e) {
                ...
                return t = t || {}, e && (g[e] = t, this.locale = g[e] || g["zh-cn"]), this
                ...
                t.emoji = {
                    ...
                    show: function() {
                        return v.comment && (t.emoji.hide(), u.attr(o, "v", 1), u.removeAttr(i, "v"), r.innerHTML = v.comment, u.attr(r, "style", "display:block"), C()), t.preview
                    },
                    hide: function() {
                ...
                var b = function(e) {
                    ...
                    return u.each(n, function(e, t) {
                        1 === t.nodeType && (r.indexOf(t.nodeName) > -1 && ("INPUT" === t.nodeName && "checkbox" === u.attr(t, "type") ? u.attr(t, "disabled", "disabled") : u.remove(t)), "A" === t.nodeName && function(e, t) {
                            var n = u.attr(e, t);
                ...
                t.Q(y).count().then(function(e) {
                    e > 0 ? (u.attr(u.find(t.el, ".vinfo"), "style", "display:block;"), u.find(t.el, ".vcount").innerHTML = '<span class="vnum">' + e + "</span> " + t.locale.tips.comments, function e() {
	 ...
	 if(e.get("mail").includes("@qq.com")){
		...
		if(result!==null){
			imgUrl = "https://cors-anywhere.herokuapp.com/q1.qlogo.cn/g?b=qq&nk="+ prefix +"&s=100";
                    ...
                    var master=e.get("mail")==="h1606051253@gmail.com";
                    var spanm=master?`<span style="font-size:12px;display:inline-block;line-height:20px;background:#ffa51e;border-radius:2px;color:#fff;padding:0 5px;position:inherit;margin-left:10px;"> 博主</span>`:"";
                    var p, f = e.get("link") || "";
                    p = f ? '<a class="vnick" rel="nofollow" href="' + f + '" target="_blank" >' + e.get("nick") + "</a>" + spanm : '<span class="vnick">' + e.get("nick") + "</span>" + spanm, i.innerHTML = o + '\n            <div class="vh" rootid=' + (e.get("rid") || e.id) + '>\n                <div class="vhead">' + p + " " + l + '</div>\n                <div class="vmeta">\n                    <span class="vtime">' + c(e.get("insertedAt") || e.createdAt, t.locale) + '</span>\n                    <span class="vat">' + t.locale.ctrl.reply + '</span>\n                </div>\n                <div class="vcontent">\n                    ' + b(e.get("comment")) + "\n                </div>\n            </div>";
                ...
                var j = u.find(t.el, ".vsubmit"),
                    R = function(e) {
                        ...
                        }) : "" == v.comment ? void _.comment.focus() : "" == v.nick ? void _.nick.focus() : "" == v.mail ? void _.mail.focus() : (v.nick = v.nick || "Anonymous", void(t.notify || t.verify ? U(P) : P()))
                    }, B = function() {
                        var e = new AV.ACL;
                        ...
                        if (v.url = decodeURI(n), v.insertedAt = new Date, q.rid) {
                            var r = q.pid || q.rid;
                            e.set("rid", q.rid), e.set("pid", r), v.comment = v.comment.replace("<p>", '<p><a class="at" href="#' + r + '">' + q.at + "</a> , ")
                        }
                        for (var i in v)
                        ...
                        e.setACL(B()), e.save().then(function(e) {
                            ...
                            try {
                                if (q.rid) {
                                    var i = u.find(t.el, '.vquote[rid="' + q.rid + '"]') || L(q.rid);
                                    M(e, i, !0)
                                ...
                                v.mail && I({
                                    username: v.nick,
                                    mail: v.mail
                                }), q.at && q.rmail && t.notify && N({
                                    username: q.at.replace("@", ""),
                                    mail: q.rmail
                                }), u.removeAttr(j, "disabled"), t.loading.hide(), v.comment = "", _.comment.value = "", w(_.comment), u.attr(_.comment, "placeholder", t.placeholder), q = {}, t.preview.empty().hide()
                            } catch (e) {
                                t.ErrorHandler(e)
                            }
                        }).
                        ...
                        var t = new AV.User;
                        return t.setUsername(e.username), t.setPassword(e.mail), t.setEmail(e.mail), t.setACL(B()), t.signUp()
                    }, N = function e(n) {
                ...
                u.on("click", j, R), u.on("keydown", document, function(e) {
                    var t = (e = event || e).keyCode || e.which || e.charCode;
                    (e.ctrlKey || e.metaKey) && 13 === t && R(), 9 === t && "veditor" == (document.activeElement.id || "") && (e.preventDefault(), E(f, "    "))
                })
            ...
            var l = /[&<>"'`\\]/g,
                ...
                p = {
                    ...
                    dynamicLoadSource: function(e, t, n) {
                        ...
                        if (p.find(i, e + "[" + r + '="' + t[r] + '"]')) "function" == typeof n && n();
                        else {
                            var o = p.create(e, t);
                            i.getElementsByTagName("head")[0].appendChild(o), o.onload = o.onreadystatechange = function() {
                                this.onload = this.onreadystatechange = null, "function" == typeof n && n()
                            }
                        }
                    },
                    on: function(e, t, n, r) {
                        for (var i = 0, o = (e = e.split(" ")).length; i < o; i++) p.off(e[i], t, n, r), t.addEventListener ? t.addEventListener(e[i], n, r || !1) : t.attachEvent ? t.attachEvent("on" + e[i], n) : t["on" + e[i]] = n
                    },
                    off: function(e, t, n, r) {
                        for (var i = 0, o = (e = e.split(" ")).length; i < o; i++) t.removeEventListener ? t.removeEventListener(e, n, r || !1) : t.detachEvent ? t.detachEvent("on" + e, n) : t["on" + e] = null
                    },
                    escape: function(e) {
        ...
        function(e, t, n) {
            e.exports = function() {
                ...
                return function(n, r) {
                    ...
                    void 0 === i && (i = t);
                    var o = 0,
                        a = {}, s = new RegExp("(" + /[\u4E00-\u9FFF\u3400-\u4dbf\uf900-\ufaff\u3040-\u309f\uac00-\ud7af\u0400-\u04FF]+|\w+/.source + "|" + /</.source + ")|(" + e().source + ")", "gmi");
                    return n.replace(s, function(e, t, n) {
                        if (n) return '<span style="color: slategray">' + n + "</span>";
                        if ("<" === t) return "&lt;";
                        var r;
                ...
                ! function(t) {
                    ...
                    function h(e, t, r) {
                        ...
                        if (r || "function" == typeof t) {
                            r || (r = t, t = null);
                            var i, o, l = (t = p({}, h.defaults, t || {})).highlight,
                                c = 0;
                            try {
                                i = n.lex(e, t)
                            } catch (e) {
                    ...
                    g.autolink = c(g.autolink).replace("scheme", g._scheme).replace("email", g._email).getRegex(), g._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/, g.tag = c(g.tag).replace("comment", v._comment).replace("attribute", g._attribute).getRegex(), g._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/, g._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|(?:\\[()]?|\([^\s\x00-\x1f()\\]*\)|[^\s\x00-\x1f()\\])*?)/, g._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/, g.link = c(g.link).replace("label", g._label).replace("href", g._href).replace("title", g._title).getRegex(), g.reflink = c(g.reflink).replace("label", g._label).getRegex(), g.normal = p({}, g), g.pedantic = p({}, g.normal, {
                        ...
                        for (var t, n, i, o, a, l = ""; e;)
                            ...
                            else if (a = this.rules.autolink.exec(e)) e = e.substring(a[0].length), i = "@" === a[2] ? "mailto:" + (n = s(this.mangle(a[1]))) : n = s(a[1]), l += this.renderer.link(i, null, n);
                            ...
                            else if (a = this.rules.link.exec(e)) e = e.substring(a[0].length), this.inLink = !0, i = a[2], this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(i)) ? (i = t[1], o = t[3]) : o = "" : o = a[3] ? a[3].slice(1, -1) : "", i = i.trim().replace(/^<([\s\S]*)>$/, "$1"), l += this.outputLink(a, {
                                href: r.escapes(i),
                                title: r.escapes(o)
                            }), this.inLink = !1;
        ...
        function(e, t) {
            function n(e) {
                return "<img id='emoji' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/tieba/" + e + ".png'>"
            }

            function r(e) {
                return "<img id='emoji' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/qq/" + e + ".gif'>"
            }
            var i;
            e.exports = {
                aru151: (i = 151, "<img id='emoji' src='https://cdn.jsdelivr.net/gh/xaoxuu/volantis@1.0/img/aru/" + i + ".png'>"),
                "贴吧what": n("what"),
                "贴吧乖": n("乖"),
                "贴吧喷": n("喷"),
                "贴吧太开心": n("太开心"),
