try {
    ...
    let siteDiv = $(`<div class="menus_item" title="${cn ? "国外" : "中国大陆"}用户访问更快"><a class="site-page" href="${cn ? "//blog.hclonely.com" : "//blog.hclonely.cn"}"><i class="fa-fw fab fa-chrome"></i><span> ${cn ? "源站" : "镜像站"}</span></a></div>`);
