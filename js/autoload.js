try {
    ...
    if($('.comment_headling').length>0) $('.comment_headling').append(`<span style="margin-left:5px;font-size:15px;">(<i class="far fa-exclamation-triangle"></i>如果此处无法评论请前往<a href="javascript:window.location.hostname='blog.hclonely.cn'" target="_self">镜像站</a>评论)</span>`)
