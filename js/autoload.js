/* global live2d_settings,initModel,waifuTipsJson,loadModel,loadGameModel,Image */
$(window).on('load', function () {
  try {
    if (!navigator.userAgent.match(/Mobile/i)) {
      ...
      if (['/blhx/', '/hqxy/', '/dal/', '/bh3/'].includes(window.location.pathname) && typeof loadGameModel === 'function') {
        ...
        /*
      if (!['/blhx/', '/hqxy/', '/dal/', '/bh3/'].includes(window.location.pathname)) {
    ...
    if ($('#visitors-map').length > 0) {
      if (navigator.userAgent.match(/Mobile/i)) {
        $('#visitors-map').append('<script type="text/javascript" id="clustrmaps" src="https://cdn.jsdelivr.net/gh/HCLonely/hclonely.github.io@1.4.6/js/map_v2.min.js?d=7RJAye3Doa8wj5huc-j4LftrwmQQMkdycswG6qp6330&cl=ffffff&w=a"></script>')
      } else {
        $('#visitors-map').append('<script type="text/javascript" id="clstr_globe" src="https://cdn.jsdelivr.net/gh/HCLonely/hclonely.github.io@1.4.6/js/globe.min.js?d=7RJAye3Doa8wj5huc-j4LftrwmQQMkdycswG6qp6330"></script>')
      }
    } else {
      $('head').append('<style>.clustrmaps-map-control{display:none !important;}</style>')
      $('body').append('<script type="text/javascript" id="clustrmaps" src="https://cdn.jsdelivr.net/gh/HCLonely/hclonely.github.io@1.4.6/js/map_v2.min.js?d=7RJAye3Doa8wj5huc-j4LftrwmQQMkdycswG6qp6330&cl=ffffff&w=a"></script>')
    }
    */
