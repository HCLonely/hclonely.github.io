    ...
    if (!navigator.userAgent.match(/Mobile/i)) {
      window.waifuTipsJson = {
        ...
        mouseover: [{
          ...
          selector: '.aplayer-pic',
          text: ['想要听点音乐吗']
        }, {
          selector: '.aplayer-icon-play',
          text: ['想要听点音乐吗']
        }, {
          selector: '.aplayer-miniswitcher',
          text: ['要显示更多播放器设置吗']
        }, {
          selector: '.aplayer-icon-back',
          text: ['要播放上一首音乐吗']
        }, {
          selector: '.aplayer-icon-forward',
          text: ['要播放下一首音乐吗']
        }, {
          selector: '.aplayer-bar-wrap',
          text: ['在这里可以调整<span style="color:#0099cc;">播放进度</span>呢']
        }, {
          selector: '.aplayer-volume-wrap',
          text: ['在这里可以调整<span style="color:#0099cc;">音量</span>呢']
        }, {
          selector: '.aplayer-icon-loop',
          text: ['在这里可以调整<span style="color:#0099cc;">播放顺序</span>呢']
        }, {
          ...
          selector: '#weather-float-he',
          text: ['要看一下天气吗？']
        }, {
          selector: "a[data-svc='wechat']",
          text: ['要加主人的微信吗？']
        }, {
          selector: "a[data-svc='sinaweibo']",
          text: ['要关注主人的微博吗？']
        }, {
          selector: "a[data-svc='steam']",
          text: ['要看主人的steam吗？']
        }, {
          selector: "a[data-svc='mailto']",
          text: ['要给主人发邮件吗？']
        }, {
          selector: "a[data-svc='github']",
          text: ['要看主人的GitHub吗？']
        }, {
          selector: "a[data-svc='twitter']",
          text: ['要关注主人的Twitter吗？']
        }, {
          selector: "a[data-svc='instagram']",
          text: ['要关注主人的Instagram吗？']
        }, {
          selector: "a[data-svc='youtube']",
          text: ['要订阅主人的YouTube吗？']
        }, {
          selector: "a[data-svc='telegram']",
          text: ['要用Telegram给主人发消息吗？']
        }, {
          selector: "a[data-svc='facebook']",
          text: ['要加主人的Facebook好友吗？']
        }, {
          selector: "a[data-svc='twitch']",
          text: ['要关注主人的Twitch吗？']
        }, {
          selector: "a[data-svc='pinterest']",
          text: ['要关注主人的Pinterest吗？']
        }, {
          selector: "a[data-svc='tumblr']",
          text: ['要关注主人的Tumblr吗？']
        }, {
          selector: '.at-expanding-share-button-toggle',
          text: ['要分享这个网页吗？']
        }, {
          selector: "a[data-name='Qzone']",
          text: ['要分享到QQ空间吗？']
        }, {
          selector: "a[data-name='Tencent QQ']",
          text: ['要分享给QQ好友吗？']
        }, {
          selector: "a[data-name='WeChat']",
          text: ['要分享到微信吗？']
        }, {
          selector: "a[data-name='Sina Weibo']",
          text: ['要分享到新浪微博吗？']
        }, {
          selector: "a[data-name='Renren']",
          text: ['要分享到人人网吗？']
        }, {
          selector: "a[data-name='Facebook']",
          text: ['要分享到Facebook吗？']
        }, {
          selector: "a[data-name='Twitter']",
          text: ['要分享到Twitter吗？']
        }, {
          selector: "a[data-name='Gmail']",
          text: ['要分享到谷歌邮箱吗？']
        }, {
          selector: "a[data-name='Copy Link']",
          text: ['要复制网页链接吗？']
        }, {
          selector: "a[data-name='Blog']",
          text: ['要前往主人的博客吗？']
        }],
        click: [{
          selector: '.waifu #live2d',
...
function switchComment() {
  var title = $('#switch-comment').attr('title') === '切换为Gitalk' ? '切换为Valine' : '切换为Gitalk';
  var i = $('#switch-comment>i');

  if ($('#gitalk-container').css('display') === 'none') {
    $('#vcomment').slideUp('normal', function () {
      $('#gitalk-container').slideDown('normal', function () {
    ...
    $('#gitalk-container').slideUp('normal', function () {
      $('#vcomment').slideDown('normal', function () {
        $('#switch-comment').attr('title', title);
        i.hasClass('fa-toggle-off') ? i.removeClass('fa-toggle-off').addClass('fa-toggle-on') : i.removeClass('fa-toggle-on').addClass('fa-toggle-off');
      });
    });
