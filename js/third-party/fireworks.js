...
if (canvasEl) {
  var ctx = canvasEl.getContext("2d"),
    ...
    canvasEl.width = window.innerWidth, canvasEl.height = window.innerHeight, canvasEl.style.width = window.innerWidth + "px", canvasEl.style.height = window.innerHeight + "px", canvasEl.getContext("2d").scale(1, 1);
  }, 500),
      render = anime({
    duration: 1 / 0,
